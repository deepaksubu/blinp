...
# This class implements a Python interface to the 'BlipUartMsg'
# message type.
#
...
class BlipUartMsg(tinyos.message.Message.Message):
    # Create a new BlipUartMsg of size 102.
