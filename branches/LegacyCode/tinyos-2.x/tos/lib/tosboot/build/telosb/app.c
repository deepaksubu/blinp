...
# 32 "ExtFlash.nc"
static  void ExtFlashM$ExtFlash$startRead(uint32_t arg_0x11fd4f0);
...
static  error_t HPLUSART0M$HPLUSARTControl$isTxIntrPending(void);

static  void HPLUSART0M$HPLUSARTControl$tx(uint8_t arg_0x12639e8);
...
static  error_t InternalFlashC$InternalFlash$read(void *arg_0x12046c8, void *arg_0x1204868, uint16_t arg_0x12049f8);
#line 60
static  error_t InternalFlashC$InternalFlash$write(void *arg_0x1202110, void *arg_0x12022b0, uint16_t arg_0x1202440);
# 34 "Leds.nc"
static  void LedsC$Leds$glow(uint8_t arg_0x120e328, uint8_t arg_0x120e4b0);
#line 33
static  void LedsC$Leds$flash(uint8_t arg_0x1210dc8);
#line 32
static  void LedsC$Leds$set(uint8_t arg_0x1210948);
# 74 "/opt/tinyos-2.x/tos/interfaces/StdControl.nc"
...
# 32 "ProgFlash.nc"
static  error_t ProgFlashM$ProgFlash$write(in_flash_addr_t arg_0x121c8b0, uint8_t *arg_0x121ca58, in_flash_addr_t arg_0x121cbe8);
# 32 "Voltage.nc"
...
# 32 "ExtFlash.nc"
static  void TOSBootM$ExtFlash$startRead(uint32_t arg_0x11fd4f0);

static  void TOSBootM$ExtFlash$stopRead(void);
#line 33
static  uint8_t TOSBootM$ExtFlash$readByte(void);
# 32 "ProgFlash.nc"
static  error_t TOSBootM$ProgFlash$write(in_flash_addr_t arg_0x121c8b0, uint8_t *arg_0x121ca58, in_flash_addr_t arg_0x121cbe8);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
# 34 "Leds.nc"
static  void TOSBootM$Leds$glow(uint8_t arg_0x120e328, uint8_t arg_0x120e4b0);
#line 33
static  void TOSBootM$Leds$flash(uint8_t arg_0x1210dc8);
#line 32
static  void TOSBootM$Leds$set(uint8_t arg_0x1210948);
# 3 "Exec.nc"
static  void TOSBootM$Exec$exec(void);
# 48 "/opt/tinyos-2.x/tos/interfaces/InternalFlash.nc"
static  error_t TOSBootM$IntFlash$read(void *arg_0x12046c8, void *arg_0x1204868, uint16_t arg_0x12049f8);
#line 60
static  error_t TOSBootM$IntFlash$write(void *arg_0x1202110, void *arg_0x12022b0, uint16_t arg_0x1202440);
# 50 "TOSBootM.nc"
...
static  error_t ExtFlashM$USARTControl$isTxIntrPending(void);

static  void ExtFlashM$USARTControl$tx(uint8_t arg_0x12639e8);
static  uint8_t ExtFlashM$USARTControl$rx(void);
#line 41
static  error_t ExtFlashM$USARTControl$isRxIntrPending(void);
# 41 "stm25p/ExtFlashM.nc"
...
#line 68
static inline void ExtFlashM$powerOnFlash(void);
#line 84
static  void ExtFlashM$ExtFlash$startRead(uint32_t addr);
#line 103
static  uint8_t ExtFlashM$ExtFlash$readByte(void);
...
inline static  error_t TOSBootM$IntFlash$write(void *arg_0x1202110, void *arg_0x12022b0, uint16_t arg_0x1202440){
#line 60
  unsigned char result;
#line 60

#line 60
  result = InternalFlashC$InternalFlash$write(arg_0x1202110, arg_0x12022b0, arg_0x1202440);
#line 60
...
#line 33
# 33 "Leds.nc"
inline static  void TOSBootM$Leds$flash(uint8_t arg_0x1210dc8){
#line 33
  LedsC$Leds$flash(arg_0x1210dc8);
#line 33
}
#line 33
...
# 48 "/opt/tinyos-2.x/tos/interfaces/InternalFlash.nc"
inline static  error_t TOSBootM$IntFlash$read(void *arg_0x12046c8, void *arg_0x1204868, uint16_t arg_0x12049f8){
#line 48
  unsigned char result;
#line 48

#line 48
  result = InternalFlashC$InternalFlash$read(arg_0x12046c8, arg_0x1204868, arg_0x12049f8);
#line 48
...
# 34 "Leds.nc"
inline static  void TOSBootM$Leds$glow(uint8_t arg_0x120e328, uint8_t arg_0x120e4b0){
#line 34
  LedsC$Leds$glow(arg_0x120e328, arg_0x120e4b0);
#line 34
}
#line 34
# 36 "msp430/HPLUSART0M.nc"
...
inline static  void ExtFlashM$USARTControl$tx(uint8_t arg_0x12639e8){
#line 42
  HPLUSART0M$HPLUSARTControl$tx(arg_0x12639e8);
#line 42
}
#line 42
# 62 "telosb/hardware.h"
...
#line 53
{
  ...
  ExtFlashM$USARTControl$tx(0xb9);
...
#line 33
#line 32
inline static  void TOSBootM$ExtFlash$startRead(uint32_t arg_0x11fd4f0){
#line 32
  ExtFlashM$ExtFlash$startRead(arg_0x11fd4f0);
#line 32
}
#line 32
# 98 "TOSBootM.nc"
...
inline static  error_t ExtFlashM$USARTControl$isTxIntrPending(void){
#line 40
  unsigned char result;
#line 40

#line 40
  result = HPLUSART0M$HPLUSARTControl$isTxIntrPending();
#line 40
...
#line 68
{
  ...
  for (i = 0; i < 5; i++) {
      ExtFlashM$USARTControl$tx(0xab);
      while (ExtFlashM$USARTControl$isTxIntrPending() != SUCCESS) ;
    }
...
# 32 "Leds.nc"
inline static  void TOSBootM$Leds$set(uint8_t arg_0x1210948){
#line 32
  LedsC$Leds$set(arg_0x1210948);
#line 32
}
#line 32
...
# 32 "ProgFlash.nc"
inline static  error_t TOSBootM$ProgFlash$write(in_flash_addr_t arg_0x121c8b0, uint8_t *arg_0x121ca58, in_flash_addr_t arg_0x121cbe8){
#line 32
  unsigned char result;
#line 32

#line 32
  result = ProgFlashM$ProgFlash$write(arg_0x121c8b0, arg_0x121ca58, arg_0x121cbe8);
#line 32
...
#line 84
{
  ...
  for (i = 4; i > 0; i--) {
      ExtFlashM$USARTControl$tx((addr >> (i - 1) * 8) & 0xff);
      while (ExtFlashM$USARTControl$isTxIntrPending() != SUCCESS) ;
    }
}

# 104 "msp430/HPLUSART0M.nc"
static  error_t HPLUSART0M$HPLUSARTControl$isTxIntrPending(void)
#line 104
{
  if (IFG1 & (1 << 7)) {
