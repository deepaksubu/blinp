...
def events_from_edges(edge_array,end_array):
    edge_subsumption_threshold=0.006944444444/1000
    min_activity_length       =0.000173611111/1000
    rejected=0
    entries=[]
    exits=[]
    ed_ctr=0
...
if __name__=="__main__":
    edge_find("/home/deepak/development/processing/PLUM/DemoData1/PLUM-Bhubaneswar/Week_1/Device_14/data0000.csv")from numpy import *
